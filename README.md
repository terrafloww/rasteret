...
Please also note that while the Rasteret library code is licensed as AGPL-3.0, the data files generated by the library are subject to the license mentioned in the [NOTICE](./NOTICE)
