# Custom Datasets With Rasteret[¶](#custom-datasets-with-rasteret)

Advanced patterns for cases where `build()`, `build_from_table()`, or `build_from_stac()` are not enough: custom dataset registration, band mapping, URL rewriting, and cloud access.
...
Next: [TorchGeo Benchmark: Rasteret vs Native Rasterio](https://terrafloww.github.io/rasteret/tutorials/05_torchgeo_benchmark_rasteret_vs_rasterio/index.md)
